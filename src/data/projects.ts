...
export const projects: Project[] = [
  {
    ...
    location: 'Denver, CO',
    state: 'Colorado',
    blurb: "A clean, contemporary Eclipse Cabinetry kitchen in Denver's Cook Street neighborhood — designed and installed by Plum Kitchens, one of our long-running Colorado dealer partners.",
    body: "Plum Kitchens is one of the standout Eclipse Cabinetry dealers in the Front Range. The Cook Street project shows how Eclipse handles a transitional, light-and-bright kitchen — cabinetry that disappears into the architecture rather than competing with it. For the deeper story on the dealership and how they've built their business, see the spotlight in the Playbook.",
    relatedPostSlug: 'dealer-spotlight-plum-kitchens',
    hero: '01-hero.webp',
    images: [
      { src: '01-hero.webp',  alt: 'Plum Kitchens Cook Street kitchen — overall view, Eclipse Cabinetry' },
