...
export const projects: Project[] = [
  ...
  },
  {
    ...
    state: 'California',
    blurb: "An Eclipse Cabinetry kitchen in Walnut Creek by Craig Lutz of Distinctive Cabinetry — Natural Walnut on the Metro slab door, a two-tone treatment with matte Smoke Stack HPL uppers over the cooktop wall, a deep-blue painted island end panel, and Wolf appliances throughout.",
